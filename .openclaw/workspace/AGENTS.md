...
- Lệnh fail → tự sửa rồi chạy lại, nhưng **TỐI ĐA 1-2 lần**. Vẫn không được thì **DỪNG NGAY** + báo gọn **1 tin** (lỗi gì + cần gì). **TUYỆT ĐỐI không thử 5-10 cách liên tục** (đừng spam hàng chục tin debug như "để em thử cách khác…").
- Không lặp lại cùng một câu/tin trạng thái nhiều lần.
- Lỗi trên Windows (encoding, đường dẫn, PowerShell) → script đã tự xử UTF-8 rồi; nếu vẫn lỗi sau 1-2 lần thì **báo anh gọn**, đừng loay hoay.
